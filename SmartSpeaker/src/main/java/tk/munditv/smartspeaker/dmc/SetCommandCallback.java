package tk.munditv.smartspeaker.dmc;
...
public class SetCommandCallback extends SetAVTransportURI  {
    private Handler handler;

    private int type;

    public SetCommandCallback(Service paramService, String paramString1,
